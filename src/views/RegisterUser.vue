  ...
  <div class="relative w-screen h-screen">
    <div class="relative z-10 flex items-center justify-center h-full">
      <v-container class="h-full relative" max-width="600">
        ...
        >
          <p class="text-center text-lg font-bold mb-4">REGISTER</p>
          ...
          <div class="flex justify-between mt-4 z-10 relative text-center">
            <v-btn class="mr-3" color="primary" @click="register">
              Register <v-icon class="ml-2">mdi-account</v-icon>
            </v-btn>
            <v-btn color="primary" @click="LogIn">
              Log In <v-icon class="ml-2">mdi-arrow-right</v-icon>
            </v-btn>
          </div>
        </v-col>
      </v-container>
